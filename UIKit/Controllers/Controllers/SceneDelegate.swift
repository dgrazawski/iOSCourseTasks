...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createTabbar() -> UITabBarController {
        ...
        tabBar.tabBar.backgroundColor = .orange
        tabBar.tabBar.tintColor = .white

        apperance.backgroundColor = .orange
        apperance.selectionIndicatorTintColor = .white
        tabBar.tabBar.unselectedItemTintColor = UIColor.gray
        tabBar.tabBar.standardAppearance = apperance
        tabBar.viewControllers = [createOnboardingNC(), createProfileNC(), createSettingsVC()]
        return tabBar
    }
